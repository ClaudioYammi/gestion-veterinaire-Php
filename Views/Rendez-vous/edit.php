...
?>
  <div class="col-md-10">
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        <a class="navbar-brand" href="#"><b>EDITER RENDEZ-VOUS</b> </a>
  ...
  <div class="container col-md-10 mt-4">
      <label  class="form-label">Date de Rendez-vous</label>
        <input type="date" name="date_heure" id="inputPassword5" class="form-control" value="<?=$rdvP['date_heure']?>" >
      <label class="form-label">Motif</label>
      <input name="motif" id="inputPassword5" class="form-control" value="<?=$rdvP['motif']?>">
      <label class="form-label">Observations</label>
      <input name="observations" id="inputPassword5" class="form-control" value="<?=$rdvP['observations']?>">
      <?php
                      ...
                      $pat = $vetoModel->getListPa();
                      $vetoModel = new VeterinaireModel();
                      $LVeto = $vetoModel->getListVeto();
